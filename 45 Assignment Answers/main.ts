...
// Task no 3
 let personName: string = "Annashra";
...
// initial list of guests
 let guests: string[] = ["Ali" , "Fatima" , "Carry" , "Rida" , "Iqra"];
...
// //Write a program that creates a list containing these items.
 ...
 console.log(country);
// Task no 21
// think of something you could store in a typescript Write a program
// that creates objects containing these items.

 let person: {name: string, fname: string , age: number} = {name: "Annashra", fname: "female", age: 16}
 console.log(person)
// Task no 22
// Intentional Error: If you haven't received an array index in one of your
